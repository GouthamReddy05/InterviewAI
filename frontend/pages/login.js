    ...
    <div class="min-h-screen flex items-center justify-center relative overflow-hidden" style="background: linear-gradient(135deg, #0f172a 0%, #1e1b4b 100%);">
        ...
        <div class="relative z-10 w-full max-w-md p-8 bg-surface-900/60 backdrop-blur-xl rounded-2xl border border-surface-700/50 shadow-2xl">
            ...
            <form id="loginForm" class="space-y-5">
                <div>
                    ...
                    <input type="text" id="username" required 
                        class="w-full bg-surface-800/80 border border-surface-700 text-white rounded-xl px-4 py-3 focus:outline-none focus:border-accent-500 focus:ring-1 focus:ring-accent-500 transition-all">
                </div>
                ...
                <button type="submit" 
                    class="w-full bg-accent-600 hover:bg-accent-500 text-white font-medium py-3 rounded-xl shadow-[0_0_15px_rgba(79,70,229,0.3)] transition-all hover:-translate-y-0.5 mt-4">
                    Sign In
                </button>
            </form>
            ...
            <div class="mt-8 text-center text-sm text-surface-400">
                ...
                <button onclick="state.step=7;render()" class="text-accent-400 hover:text-accent-300 font-medium transition-colors">Sign up</button>
            </div>
        </div>
    </div>
    `;
